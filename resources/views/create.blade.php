...
<body>
    ...
    <form action="{{route('contato.store')}}" method="POST" enctype="multipart/form-data" id="form">
        {{ csrf_field() }}
        <div class="form-row">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control" name="lagradouro" placeholder="Rua Maria dos anjos" required>
            </div>
            
            <div class="form-group col-md-1">
                <label for="numero">Número</label>
                <input type="text" class="form-control" name="numero" placeholder="000" required>
            </div>
